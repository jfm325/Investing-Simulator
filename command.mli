...
(** The type [object_phrase] represents the object phrase that can be
    ...
    - If the player command is ["buy TSLA 50"], then the object phrase
    is [\["TSLA"; "50"\]].

    - The first element in the object pharse represents the stock and
...
(** [parse str] parses a player's input into a [command], as follows.
    ...
    - [parse "buy TSLA 50"] is [Buy \["TSLA"; "50"\]] - [parse "cash"]
    is [Cash].
    ...
    malformed} if the verb is neither "quit" nor "go", or if the verb is
    "cash" / "networth" and there is a non-empty object phrase, or if
